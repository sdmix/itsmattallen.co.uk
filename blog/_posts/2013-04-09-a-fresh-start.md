...
description: The Matt Allen (sdmix) Blog - Have a read of how I started this lovely new site off and how it’s all starting to fall into place.
catagories: blog
meta:
---
...
<div class="wrapper spacer2">
    ...
    into code and I thought the best way to do that was to rebuild my website from
    the ground up.</p>
...
<div class="wrapper spacer2">
    ...
    dive through the code (especially if you're a designer!) and learn what you can
